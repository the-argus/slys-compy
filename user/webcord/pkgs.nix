{ pkgs, ... }:
{
  comfy = pkgs.stdenv.mkDerivation {
    name = "comfy-theme";
    src = pkgs.fetchgit {
      url = "https://github.com/Comfy-Themes/Discord";
      rev = "2c21ad67b1263782c279ad9e3625e8581dbde1cf";
      sha256 = "1crzsp68dgjdwmhsd1ksjib3g1p7pcm4hm9awc0djm2w9gihav6n";
    };
    installPhase = ''
      mkdir $out
      cp  $src/betterdiscord/* $out
    '';
  };
  ...
  lavender = pkgs.fetchgit {
    ...
    rev = "9183d1825e0f8c8d714070a7960ac6d978234017";
    sha256 = "1iar0dx6f2lrvfk82l3wmdwbdv9ns40ncssjsc1k7sl9qrkzw2sw";
  };
